...
-- Se implementan las tareas declaradas en la especificacion (.ads)

-- TareaGenerarAviones genera los distintos aviones y les asigna velocidades
-- Para cada avion generado se crea una nueva tarea dinamica T_TareaAvion
